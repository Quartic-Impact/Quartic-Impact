    ...
    EntityTrigger = ig.Entity.extend({
      ...
      _wm: new ig.Config({
        _attributes: {
          checks: {
            _type: 'String',
            _info: 'Specifies which type of entity can trigger this trigger. A, B or BOTH',
            _default: 'A',
          },
          wait: {
            _type: 'Number',
            _info:
              "Time in seconds before this trigger can be triggered again. Set to -1 to specify 'never' - e.g. the trigger can only be triggered once.",
            _default: -1,
          },
          target: {
            _type: 'String',
            _info: 'Name of entity whose triggeredBy method will be called.',
          },
        },
      }),
      _wmScalable: true,
