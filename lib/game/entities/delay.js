    ...
    EntityDelay = ig.Entity.extend({
      _wm: new ig.Config({
        _attributes: {
          delay: {
            _type: 'Number',
            _info: 'Delay in seconds after which the targets should be triggered',
            _default: 1,
          },
          target: {
            _type: 'String',
            _info:
              'Names of the entities whose triggeredBy() method will be called after the delay',
          },
        },
      }),
      _wmDrawBox: true,
